...
import com.engagedryan.giflib.web.Color;
...
public class CategoryController {
    ...
    public String addCategory(@Valid Category category, BindingResult result, RedirectAttributes redirectAttributes) {
        ...
        if (result.hasErrors()){
            //Include validation errors upon attribute
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage("Congratulations, You've Succesfully added the category!", FlashMessage.Status.SUCCESS));
